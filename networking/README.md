...
关于Pod和Service[Service](http://kubernetes.io/docs/user-guide/connecting-applications/#the-kubernetes-model-for-connecting-containers)之间的通信方式，将会在[这里](./pod-service.md)进行介绍。
